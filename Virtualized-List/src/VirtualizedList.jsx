...
export const VirtualizedList = ({list,height,itemHeight,width}) => {
    ...
    const [indices,setIndices]=useState([0,elementsVisibileInWindow])
  ...
  return (
    <div className='container' style={{height,width,background:'grey',overflow:"auto"}} onScroll={handleScroll}>
